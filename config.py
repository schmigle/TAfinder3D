...
def parse_args():
    parser = ArgumentParser(description="Identify types I-VIII toxin-antitoxin loci in bacterial genome with Foldseek structural validation.")
    ...
    # Scoring cutoff options - can use either bitscore (default) or e-value
